                ...
                <article>
                    <ScrollArea className="h-[700px] max-w-[1250px] rounded">
                        ...
                        <h2 className={"text-sm py-1.5 sm:text-lg md:text-xl lg:text-2xl font-bold"}>Hébergeur du site
                            :</h2>
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}>RedHeberg</p>
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}><a href="redheberg.fr">Lien vers
                            le site web</a></p>
                        <br/>
                        <h2 className={"text-sm py-1.5 sm:text-lg md:text-xl lg:text-2xl font-bold"}>Politique de
                            confidentialité :</h2>
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}>Fast Sushi s'engage à protéger
                            ...
                            à des tiers sans consentement préalable. Les utilisateurs disposent d'un droit d'accès,
                        ...
                        <br/>
                        <h2 className={"text-sm py-1.5 sm:text-lg md:text-xl lg:text-2xl font-bold"}>Termes et Conditions :</h2>
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}>En utilisant le site Fast Sushi,
                            ...
                            Fast Sushi se réserve le droit de modifier, suspendre ou interrompre le site à tout moment,
                            ...
                            En passant commande sur Fast Sushi, vous acceptez les conditions de vente et de livraison
                            en vigueur.</p>
                        <br/>
                        ...
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}>Tous les éléments du site
                            Fast Sushi, qu'ils soient visuels ou textuels, sont la propriété exclusive de Fast Sushi
                            et sont protégés par les lois relatives à la propriété intellectuelle.
                            Toute reproduction ou utilisation sans autorisation préalable est strictement interdite.</p>
                        <br/>
                        ...
                        <p className={"text-xs py-2 sm:text-sm md:text-lg lg:text-xl"}>En cas de litige concernant le
                            site Fast Sushi, le droit français est applicable. En cas de litige, une solution amiable
