            ...
            <section className={"w-full"}>
                <Carousel className={"max-w-sm mx-auto"}>
                    <CarouselContent className={"items-center"}>
                        <CarouselItem><Image className={"rounded-sm"} src={"/storyAssets/sushi-oke.jpg"} width={"1000"} height={"1000"} alt={""}/></CarouselItem>
                        <CarouselItem><Image className={"rounded-sm"} src={"/entree.jpg"} width={"1000"} height={"1000"} alt={""}/></CarouselItem>
                        <CarouselItem><Image className={"rounded-sm"} src={"/storyAssets/Cooking-class.jpg"} width={"1000"} height={"500"} alt={""}/></CarouselItem>
                        <CarouselItem><Image className={"rounded-sm"} src={"/storyAssets/chief.png"} width={"1000"} height={"500"} alt={""}/></CarouselItem>
                    </CarouselContent>
                    <CarouselPrevious />
                    <CarouselNext />
                </Carousel>
